...
// Convenience exports for common feature gates
export const AuthFeatureGate = (props: Omit<FeatureGateProps, 'feature'> & { feature?: string }) => (
  <FeatureGate feature={props.feature || 'googleSignIn'} {...props} />
);

export const VideoFeatureGate = (props: Omit<FeatureGateProps, 'feature'> & { feature?: string }) => (
  <FeatureGate feature={props.feature || 'videoQuestions'} {...props} />
);

export const ExperimentalFeatureGate = (props: Omit<FeatureGateProps, 'feature'> & { feature: string }) => (
  <FeatureGate {...props} />
);
